...
public class Evaluator {
	public static double evaluate(String goldfile, String predfile, PrintWriter out, ParserModel model) throws TrainingException{
		...
		try {
			...
			while(goldInst != null){
				...
				for(int i = 0; i < goldInst.length(); ++i){
					total++;
