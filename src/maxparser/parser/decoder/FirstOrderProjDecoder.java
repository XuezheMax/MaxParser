...
import maxparser.parser.decoder.forest.FirstOrderForest;
...
public class FirstOrderProjDecoder extends Decoder{
	...
	public Pair<FeatureVector, String>[] decode(Manager manager, DependencyInstance inst, int K, ParserModel model) {
		...
		FirstOrderForest forest = new FirstOrderForest(length - 1, K);
		FirstOrderForestIndexTuple forestIndex = new FirstOrderForestIndexTuple();
