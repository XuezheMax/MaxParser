...
public abstract class Parser {
	...
	public void train(Trainer trainer, TypeLabeler typeLabeler, ParserModel model, String trainfile, String devfile, String logfile) throws TrainingException {
		this.model = model;
		...
		manager.init(nums[0]);
		trainer.train(manager, decoder, model, trainfile, devfile, logfile, nums[1], nums[2]);
	}
}
